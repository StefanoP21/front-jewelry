...
const OrderPDF: React.FC<PDFProps> = ({
  orderNumber,
  orderDate,
  chargeToName,
  chargeToEmail,
    ...
    <Page style={styles.page}>
      ...
      <View style={styles.row}>
        ...
        <View style={[styles.largeItem, { alignItems: "flex-end" }]}>
          ...
          <Text style={styles.text}>Número de venta: {orderNumber}</Text>
          <Text style={styles.text}>Fecha de venta: {orderDate}</Text>
      ...
      <View style={[styles.verticalRow, { marginTop: "12px" }]}>
        ...
        <View style={[styles.row, { marginTop: "12px" }]}>
          <View style={[styles.largeItem, { alignItems: "flex-end" }]}>
            ...
            <Text style={styles.text}>Descuento: {discount}</Text>
            <Text style={styles.text}>Total: {total}</Text>
            <Text style={styles.text}>Información de pago: {paymentInfo}</Text>
          </View>
        </View>
      </View>
    </Page>
